...
namespace MyShop.Areas.Admin.Controllers
{
    public class SlidersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SliderID,Url,SliderTitle,ImageName,StartDate,EndDate,IsActive")] Slider slider, HttpPostedFileBase imgUp)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SliderID,Url,SliderTitle,ImageName,StartDate,EndDate,IsActive")] Slider slider, HttpPostedFileBase imgUp)
        {
            if (ModelState.IsValid)
            {
                if (imgUp != null)
