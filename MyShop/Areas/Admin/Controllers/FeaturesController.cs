...
namespace MyShop.Areas.Admin.Controllers
{
    public class FeaturesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FeatureId,FeaturesTitle")] Features features)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FeatureId,FeaturesTitle")] Features features)
        {
            if (ModelState.IsValid)
            {
